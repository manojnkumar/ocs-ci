    ...
    def run_pillowfights(self, replicas=1, num_items=None, num_threads=None):
        ...
        for i in range(replicas):
            for pf_yaml in pf_files:
                ...
                # num of items
                pfight['spec']['template']['spec']['containers'][0]['command'][4] = str(num_items) if num_items else '20000'
                # num of threads
                pfight['spec']['template']['spec']['containers'][0]['command'][13] = str(num_threads) if num_threads else '20'
